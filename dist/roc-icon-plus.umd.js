/**
 * roc-icon-plus v1.0.1
 * (c) 2020-2024 rocyuan
 * Email: rocyuan666@163.com
 * Released under the MIT License.
 */
(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?module.exports=f(require('vue')):typeof define==='function'&&define.amd?define(['vue'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,g.RocIconPlus=f(g.Vue));})(this,(function(vue){'use strict';/******************************************************************************
...
var script = /*#__PURE__*/ vue.defineComponent(__assign(__assign({}, __default__), { props: {
        ...
        return function (_ctx, _cache) {
            return (vue.openBlock(), vue.createElementBlock("span", {
                class: vue.normalizeClass(["roc-icon-plus", classOptions]),
                style: styleOptions
            }));
        };
